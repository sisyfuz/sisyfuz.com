...
export default function NotFound() {
    return (
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 font-mono uppercase text-center relative overflow-hidden">
            ...
            {/* Een subtiele achtergrond-ruis / glitch effect simulatie */}
            ...
            <div className="relative z-10 flex flex-col items-center">
                <h1 className="text-8xl md:text-[12rem] font-black text-pink-500 mb-2 tracking-tighter" style={{ textShadow: "0 0 40px rgba(255, 105, 180, 0.4)" }}>
                    404
                </h1>

                <h2 className="text-xl md:text-3xl mb-6 tracking-widest text-slate-300">
                ...
                >
                    ...
                    <span className="text-[10px] tracking-[0.3em] group-hover:text-pink-500 transition-colors">
